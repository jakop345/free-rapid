...
public abstract class SingleXFrameApplication extends SingleFrameApplication {
     ...
     * {@inheritDoc} <p>
     * <p/>
     * Overridden to force a JFrame as main frame and inject SwingX specific session properties.
     */
    @Override
    ...
    protected JFrame createXMainFrame() {
        JFrame xFrame = createXFrame();
        ApplicationContext appContext = getContext();
