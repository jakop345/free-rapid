...
import cz.cvut.felk.gpx.core.AppPrefs;
import cz.cvut.felk.gpx.core.Consts;
import cz.cvut.felk.gpx.core.MainApp;
...
public final class LookAndFeels {
    ...
    private LookAndFeels() {
        ...
        final String selectedLookAndFeelClassName = AppPrefs.getProperty(AppPrefs.LOOK_AND_FEEL_SELECTED_KEY, KUNSTSTOFF);
        final boolean opaque = AppPrefs.getProperty(AppPrefs.LOOK_AND_FEEL_OPAQUE_KEY, true);
        String selectedTheme = AppPrefs.getProperty(AppPrefs.THEME_SELECTED_KEY, "");
    ...
    public final void storeSelectedLaF(final LaF laf) {
        ...
        AppPrefs.storeProperty(AppPrefs.LOOK_AND_FEEL_SELECTED_KEY, laf.getClassName());
        AppPrefs.storeProperty(AppPrefs.LOOK_AND_FEEL_OPAQUE_KEY, laf.isToolbarOpaque());
        if (!laf.hasThemeClass()) {
            AppPrefs.removeProperty(AppPrefs.THEME_SELECTED_KEY);
        } else
            AppPrefs.storeProperty(AppPrefs.THEME_SELECTED_KEY, laf.getThemeClass());
