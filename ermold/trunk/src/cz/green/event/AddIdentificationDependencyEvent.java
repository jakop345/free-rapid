...
public class AddIdentificationDependencyEvent extends cz.green.event.CoordinateEvent {
     ...
     */
    public AddIdentificationDependencyEvent(int x, int y, cz.green.event.Item item, java.awt.Component comp) {
        super(x, y, comp);
        this.item = item;
    }
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddIdentificationDependencyEvent(int x, int y, cz.green.event.Item item, java.awt.Component comp, boolean add) {
        this(x, y, item, comp);
        this.add = add;
    }
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddIdentificationDependencyEvent(cz.green.event.CoordinateEvent event, cz.green.event.Item item) {
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddIdentificationDependencyEvent(cz.green.event.CoordinateEvent event, cz.green.event.Item item, boolean add) {
