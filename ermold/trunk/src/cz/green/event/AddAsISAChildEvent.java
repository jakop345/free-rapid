 ...
 */
public class AddAsISAChildEvent extends cz.green.event.CoordinateEvent {
    /**
     ...
     */
    public AddAsISAChildEvent(int x, int y, cz.green.event.Item item, java.awt.Component comp) {
        super(x, y, comp);
        this.item = item;
    }
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(int x, int y, cz.green.event.Item item, java.awt.Component comp, boolean add) {
        this(x, y, item, comp);
        this.add = add;
    }
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(cz.green.event.CoordinateEvent event, cz.green.event.Item item) {
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(cz.green.event.CoordinateEvent event, cz.green.event.Item item, boolean add) {
