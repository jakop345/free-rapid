...
public class AddAsISAChildEvent extends cz.green.event.CoordinateEvent {
     ...
     */
    private AddAsISAChildEvent(int x, int y, Item item, java.awt.Component comp) {
        super(x, y, comp);
        this.item = item;
    }
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(cz.green.event.CoordinateEvent event, Item item) {
     ...
     * @see cz.green.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(cz.green.event.CoordinateEvent event, Item item, boolean add) {
