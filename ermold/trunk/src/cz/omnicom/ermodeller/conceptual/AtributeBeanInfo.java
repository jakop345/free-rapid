...
public class AtributeBeanInfo extends java.beans.SimpleBeanInfo {
        ...
        try {
            try {
                ...
                try {
                    /* Attempt to find the method using getMethod with parameter types. */
                    java.lang.Class aSetMethodParameterTypes[] = {
                            cz.omnicom.ermodeller.conceptual.ConceptualConstruct.class
                    };
        ...
        try {
            try {
                ...
                try {
                    /* Attempt to find the method using getMethod with parameter types. */
                    java.lang.Class aSetMethodParameterTypes[] = {
                            cz.omnicom.ermodeller.datatype.DataType.class
                    };
    ...
    public java.beans.BeanDescriptor getBeanDescriptor() {
        ...
        try {
            ...
            aDescriptor = new java.beans.BeanDescriptor(cz.omnicom.ermodeller.conceptual.Atribute.class);
            /* aDescriptor.setExpert(false); */
            /* aDescriptor.setHidden(false); */
