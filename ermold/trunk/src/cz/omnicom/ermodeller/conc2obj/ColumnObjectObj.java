 ...
 */
public class ColumnObjectObj extends RowObj {
    /**
     ...
     *
     */
    public ColumnObjectObj(AtributeC2R anAtribute) {
     ...
     */
    public Icon getIcon() {
        return new ImageIcon(ClassLoader.getSystemResource("img/integrity.gif"));
    }
