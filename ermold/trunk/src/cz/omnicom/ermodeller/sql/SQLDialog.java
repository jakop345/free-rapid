 ...
 */
public class SQLDialog extends JDialog implements java.awt.event.ActionListener, javax.swing.event.TreeSelectionListener {
...
/* WARNING: THIS METHOD WILL BE REGENERATED. */
     ...
     */
    public SQLDialog(Frame owner, SchemaSQL aSchemaSQL) {
        super(owner);
        setSchemaSQL(aSchemaSQL);
        initialize();
    }
...
/* WARNING: THIS METHOD WILL BE REGENERATED. */
    private void connEtoC2(javax.swing.event.TreeSelectionEvent arg1) {
        try {
            // user code begin {1}
            // user code end
            this.sQLTree_ValueChanged(arg1);
            // user code begin {2}
            // user code end
        } catch (java.lang.Throwable ivjExc) {
            // user code begin {3}
...
/* WARNING: THIS METHOD WILL BE REGENERATED. */
     ...
     *
     * @see cz.omnicom.ermodeller.sql.SchemaSQL#createTree
     */
    private void createTree() {
        ivjRoot = getSchemaSQL().createTree();
...
/* WARNING: THIS METHOD WILL BE REGENERATED. */
    ...
    public static void main(java.lang.String[] args) {
        try {
            SQLDialog aSQLDialog;
            aSQLDialog = new SQLDialog();
    ...
    public void saveButton_ActionPerformed(java.awt.event.ActionEvent actionEvent) throws java.io.IOException {
        ...
        if (fileName != null) {
            ...
            if (i > -1) {
                ...
                getJFileChooser2().setCurrentDirectory(new java.io.File(dir));
            ...
            String name = getSchemaSQL().getName();
            String extension;
            try {
     ...
     * @see #createTree
     */
    public synchronized void setSchemaSQL(SchemaSQL aSchemaSQL) {
        // Sets errorloglist
        ivjSchemaSQL = (aSchemaSQL == null) ? new SchemaSQL() : aSchemaSQL;
    ...
    public void sQLTree_ValueChanged(javax.swing.event.TreeSelectionEvent treeSelectionEvent) {
        ...
        if (o instanceof SubSQLProducer)
            getJTextArea1().setText(((SubSQLProducer) o).createSubSQL(0));
        else
