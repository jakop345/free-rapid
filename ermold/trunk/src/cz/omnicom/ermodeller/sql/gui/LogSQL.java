 ...
 * @author:
 */
public class LogSQL extends javax.swing.JDialog {

    class IvjEventHandler implements java.awt.event.ActionListener {
        public void actionPerformed(java.awt.event.ActionEvent e) {
            if (e.getSource() == LogSQL.this.getClearButton())
                connEtoC1(e);
        }
     ...
     */
    public LogSQL(java.awt.Dialog owner) {
        super(owner);
    }
     ...
     */
    public LogSQL(java.awt.Dialog owner, String title) {
        super(owner, title);
    }
     ...
     * @param modal boolean
     */
    public LogSQL(java.awt.Dialog owner, String title, boolean modal) {
     ...
     * @param modal boolean
     */
    public LogSQL(java.awt.Dialog owner, boolean modal) {
        super(owner, modal);
    }
     ...
     */
    public LogSQL(java.awt.Frame owner) {
        super(owner);
    }
     ...
     * @param title java.lang.String
     */
    public LogSQL(java.awt.Frame owner, String title) {
        super(owner, title);
    }
     ...
     * @param modal boolean
     */
    public LogSQL(java.awt.Frame owner, String title, boolean modal) {
        super(owner, title, modal);
    }
     ...
     * @param modal boolean
     */
    public LogSQL(java.awt.Frame owner, boolean modal) {
        super(owner, modal);
    }
