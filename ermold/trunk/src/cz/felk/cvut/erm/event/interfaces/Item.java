...
public interface Item extends SelectableItem, MovableItem {
     ...
     *          If <code>dimension</code> is less then <code>0</code> or
     *          greater then <code>1</code>.
     * @see cz.felk.cvut.erm.util.IntervalMethods
     */
    Item itemIn(int dimension, int[] interval, int where, int myPosition) throws cz.felk.cvut.erm.util.BadDimensionException, ValueOutOfRangeException;
     ...
     *          greater then <code>1</code>.
     * @see cz.felk.cvut.erm.util.IntervalMethods
     * @see cz.felk.cvut.erm.util.IntervalMethods#whereIs(int[], int[])
     */
    int position(int dimension, int[] interval) throws cz.felk.cvut.erm.util.BadDimensionException, ValueOutOfRangeException;
