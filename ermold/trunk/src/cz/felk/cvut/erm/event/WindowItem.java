...
public class WindowItem implements Item, java.io.Serializable {
     ...
     * @see Item#countLinks(cz.felk.cvut.erm.event.interfaces.Item)
     */
     ...
     * @see Item#countLinksTo(cz.felk.cvut.erm.event.interfaces.Item , cz.felk.cvut.erm.event.interfaces.Item)
     */
     ...
     * @see cz.felk.cvut.erm.event.interfaces.PaintableItem#getBounds()
     ...
     * @see Manager#remove(cz.felk.cvut.erm.event.interfaces.Item)
     */
     ...
     * @see ResizeEvent
     * @see ResizeEvent
     * @see cz.felk.cvut.erm.event.interfaces.MovableItem
     */
     ...
     * <code>interval</code>.
     *
     * @see cz.felk.cvut.erm.event.interfaces.Item#itemIn(int, int[], int, int)
     */
    public Item itemIn(int dimension, int[] interval, int where, int myPosition) throws cz.felk.cvut.erm.util.BadDimensionException, ValueOutOfRangeException {
        Item item = this;
        try {
            while (true) {
     ...
     *
     * @see cz.felk.cvut.erm.event.interfaces.MovableItem#managerMoves(int, int, boolean)
     */
     ...
     */
    public int position(int dimension, int[] interval) throws cz.felk.cvut.erm.util.BadDimensionException, ValueOutOfRangeException {
        try {
