...
import cz.felk.cvut.erm.event.interfaces.Event;
...
public class DesktopGroupWindow extends GroupWindowItem implements ContainerDesktop, java.io.Serializable {
     ...
     * @see MovingEvent
     * @see ResizingEvent
     * @see fallAndHandleEvent(int, int, cz.felk.cvut.erm.event.interfaces.Event )
     */
    transient protected cz.felk.cvut.erm.event.interfaces.Event preEvent = null;
    /**
     ...
     *
     * @see selectItem( cz.felk.cvut.erm.event.interfaces.SelectableItem , boolean)
     * @see selectItemEx( cz.felk.cvut.erm.event.interfaces.SelectableItem , boolean)
     */
...
//		throw new ImpossibleNegativeValueException();
     ...
     *
     * @see GroupWindowItem#fallAndHandleEvent(int, int, cz.felk.cvut.erm.event.interfaces.Event)
     ...
     *
     * @see cz.felk.cvut.erm.event.interfaces.PaintableManager#getScale()
     */
