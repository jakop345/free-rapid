...
import cz.felk.cvut.erm.event.interfaces.*;
import cz.felk.cvut.erm.util.BadDimensionException;
import cz.felk.cvut.erm.util.IntervalMethods;
import cz.felk.cvut.erm.util.IntervalMethodsException;
...
public class GroupWindowItem extends WindowItem implements Manager, java.io.Serializable {
     ...
     *
     * @see cz.felk.cvut.erm.util.MoveArrayList
     * @see Item
     */
     ...
     * parameters).
     *
     * @see WindowItem#WindowItem(cz.felk.cvut.erm.event.interfaces.Manager , int, int, int, int)
     */
     ...
     *
     * @see Manager#countAllLinksToTop(cz.felk.cvut.erm.event.interfaces.Item)
     */
     ...
     *
     * @see Manager#fallAndHandleEvent(int, int, cz.felk.cvut.erm.event.interfaces.Event)
     * @see isIn(int,int)
     * @see invokeEventHandler( cz.felk.cvut.erm.event.interfaces.Event )
     */
    public boolean fallAndHandleEvent(int x, int y, cz.felk.cvut.erm.event.interfaces.Event event) {
     ...
     *
     * @see Invokable#invokeEventHandler(cz.felk.cvut.erm.event.interfaces.Event)
     * @see GroupWindowItem.receiver
     */
    public boolean invokeEventHandler(cz.felk.cvut.erm.event.interfaces.Event event) {
     ...
     *
     * @see Manager#isBottom(cz.felk.cvut.erm.event.interfaces.Item)
     * @see GroupWindowItem.wins
     */
     ...
     *
     * @see Manager#isTop(cz.felk.cvut.erm.event.interfaces.Item)
     * @see GroupWindowItem.wins
     */
...
//		throw new ItemNotInsideManagerException();
     ...
     *
     * @see cz.felk.cvut.erm.event.interfaces.Manager#remove(cz.felk.cvut.erm.event.interfaces.Item)
     */
     ...
     *
     * @see PaintableManager#repaintItemFast(cz.felk.cvut.erm.event.interfaces.PaintableItem)
     */
     ...
     * to set selected a <code>item</code>.
     *
     * @see PaintableManager#selectItemEx(cz.felk.cvut.erm.event.interfaces.SelectableItem , boolean)
     */
