 ...
 */
public class AddAsISAChildEvent extends cz.felk.cvut.erm.event.CoordinateEvent {
    /**
     ...
     */
    public AddAsISAChildEvent(int x, int y, Item item, java.awt.Component comp) {
        super(x, y, comp);
        this.item = item;
    }
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(int x, int y, Item item, java.awt.Component comp, boolean add) {
        this(x, y, item, comp);
        this.add = add;
    }
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(cz.felk.cvut.erm.event.CoordinateEvent event, Item item) {
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddAsISAChildEvent(cz.felk.cvut.erm.event.CoordinateEvent event, Item item, boolean add) {
