 ...
 */
public class AddConnectionEvent extends cz.felk.cvut.erm.event.CoordinateEvent {
    /**
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddConnectionEvent(cz.felk.cvut.erm.event.CoordinateEvent event, Item item) {
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public AddConnectionEvent(cz.felk.cvut.erm.event.CoordinateEvent event, Item item, boolean add) {
