...
public class ConnectionArrow extends ConnectionLine {
     ...
     *
     * @see ConnectionLine#ConnectionLine(cz.felk.cvut.erm.event.interfaces.Manager , cz.felk.cvut.erm.ermodeller.Connectable, cz.felk.cvut.erm.ermodeller.Connectable)
     */
