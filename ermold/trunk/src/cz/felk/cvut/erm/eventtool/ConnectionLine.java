 ...
 */
public class ConnectionLine extends cz.felk.cvut.erm.eventtool.Window implements
        Connection {
    /**
     ...
     * @see cz.felk.cvut.erm.eventtool.interfaces.Connection#getOne()
     */
     ...
     *
     * @see cz.felk.cvut.erm.event.interfaces.PaintableManager#repaintRectangle(int, int, int, int)
     */
     ...
     *
     * @return The connectable window.
     * @see cz.felk.cvut.erm.eventtool.interfaces.Connection#setTwo()
     */
