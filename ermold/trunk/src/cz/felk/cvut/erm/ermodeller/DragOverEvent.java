...
public class DragOverEvent extends cz.felk.cvut.erm.event.CoordinateEvent {
     ...
     */
    public DragOverEvent(int x, int y, Item item, java.awt.Component comp) {
        super(x, y, comp);
        this.item = item;
    }
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public DragOverEvent(int x, int y, Item item, java.awt.Component comp, boolean add) {
        this(x, y, item, comp);
        this.add = add;
    }
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public DragOverEvent(cz.felk.cvut.erm.event.CoordinateEvent event, Item item) {
     ...
     * @see cz.felk.cvut.erm.event.CoordinateEvent#CoordinateEvent(int, int, java.awt.Component)
     */
    public DragOverEvent(cz.felk.cvut.erm.event.CoordinateEvent event, Item item, boolean add) {
