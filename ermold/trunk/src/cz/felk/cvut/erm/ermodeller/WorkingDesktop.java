...
public class WorkingDesktop extends DesktopTool implements FontManager,
    ...
    public void composeEntityOld(Entity e1,
        ...
        ent2.handleRemoveEvent(new cz.felk.cvut.erm.event.RemoveEvent(0, 0,
                getPaintPlace()));
    }
     ...
     *
     * @see cz.felk.cvut.erm.ermodeller.interfaces.ISchema#createEntity(int, int, EntityConstruct)
     */
     ...
     *
     * @see cz.felk.cvut.erm.ermodeller.interfaces.ISchema#createRelation(int, int)
     */
...
//				System.out.println("Stored");
     ...
     * @see cz.felk.cvut.erm.event.interfaces.Manager#changeZOrder(cz.felk.cvut.erm.event.interfaces.Item , boolean)
     */
