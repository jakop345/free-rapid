...
import cz.felk.cvut.erm.conceptual.exception.MustHave2ConnectionsException;
 ...
 */
    protected JPopupMenu createMenu(JPopupMenu menu, PopupMenuEvent event) {
        ...
        //addMenuItem(menu, "Compose with relation", "mCompEntity.gif", event.getComponent(), "composingRelation", this, cz.felk.cvut.erm.ermodeller.Relation.class);
        if (getNotationType() == CHEN)
...
//        r = null;
     ...
     * @throws cz.felk.cvut.erm.conceptual.ParameterCannotBeNull
