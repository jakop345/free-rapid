...
public class SubmitErrorInfo extends AbstractBean {
    ...
    public SubmitErrorInfo(ErrorInfo errorInfo) {
        ...
        this.setName(AppPrefs.getProperty(AppPrefs.SUBMIT_ERROR_NAME));
        this.setEmail(AppPrefs.getProperty(AppPrefs.SUBMIT_ERROR_EMAIL));
    }
    ...
    public String toURLPostData() {
        AppPrefs.storeProperty(AppPrefs.SUBMIT_ERROR_EMAIL, getEmail());
        AppPrefs.storeProperty(AppPrefs.SUBMIT_ERROR_NAME, getName());
