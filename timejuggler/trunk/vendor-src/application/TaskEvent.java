...
/**
 * An encapsulation of the value produced one of the {@code Task} execution methods: {@code doInBackground()}, {@code
 * process}, {@code done}. The source of a {@code TaskEvent} is the {@code Task} that produced the value.
 * @see TaskListener
 * @see Task
 */
