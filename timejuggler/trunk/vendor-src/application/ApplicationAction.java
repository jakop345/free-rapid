 ...
 * depending on the value of block property.  For example, if the value of block is <tt>Block.ACTION</tt>, then the
 * action will be disabled while the actionPerformed method runs.
 * <p/>
 * <p/>
...
public class ApplicationAction extends AbstractAction {
    ...
    /**
     * The name of the enabledProperty whose value is returned by {@link #isEnabled isEnabled}, or null.
    ...
    */
     ...
     * <p/>
     * <p/>
     * [TBD explain the &#064;Action block=XXX parameter in more detail, likewise for exception handling.
    ...
    /**
     * If the proxy action is null and <tt>enabledProperty</tt> was specified, then return the value of the enabled
     * property. Otherwise return the value of this Action's enabled property by invoking the corresponding
     * <tt>is/get</tt> method on <tt>appAM.getActionsObject()</tt>.
     * <p/>
    ...
    /**
     * If the proxy action is null and <tt>enabledProperty</tt> was specified, then set the value of the enabled
     * property by invoking the corresponding <tt>set</tt> method on <tt>appAM.getActionsObject()</tt>.  Otherwise
     * return the value of this Action's enabled property.
     * <p/>
     * TBD: explain exception handling
