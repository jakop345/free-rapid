...
public class ApplicationContext extends AbstractBean {
    ...
    /**
     * Returns a {@link ResourceMap#getParent chain} of two or more ResourceMaps.  The first encapsulates the
     * ResourceBundles defined for the specified class, and its parent encapsulates the ResourceBundles defined for the
     * entire application.
     * <p/>
    ...
    /**
     * Returns a {@link ResourceMap#getParent chain} of two or more ResourceMaps.  The first encapsulates the
     * ResourceBundles defined for the all of the classes between {@code startClass} and {@code stopClass} inclusive.
     * It's parent encapsulates the ResourceBundles defined for the entire application.
     * <p/>
     * This is just a convenience method that calls {@link ResourceManager#getResourceMap(Class, Class)
     * ResourceManager.getResourceMap()}.  It's defined as:
     * <pre>
