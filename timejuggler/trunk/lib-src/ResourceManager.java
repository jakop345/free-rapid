 ...
 * in a {@code resources} subpackage.  The subpackage may also contain
 * a ResourceBundle with resources to be shared by the entire package,
 * called {@code PackageResources}, and the Application class itself
 ...
 * <p>
 * The mapping from classes, packages, and {@code Application} to a list
 * ResourceBundle names is handled by three protected methods: 
 * {@link #getClassBundleNames(Class) getClassBundleNames},
 * {@link #getPackageBundleNames(Class) getPackageBundleNames},
...
public class ResourceManager extends AbstractBean {
    ...
    /**
     * Construct a {@code ResourceManager}.  Typically applications will not create a 
     * ResourceManager directly, they'll retrieve the shared one from
    ...
    /**
     * Called by {@link #getResourceMap} to lazily construct {@code ResourceMaps}.
     * By default this method is effectively just:
     * <pre>
     * return new ResourceMap(parent, classLoader, bundleNames);
     * </pre>
     * ResourceManager subclasses might override this method to construct their
     * own ResourceMap subclasses instead.
     */
     ...
     * class.  Its parent ResourceMap encapsulates the ResourceBundles
     * shared by the class's package, and remaining ResourceMaps in the
     * chain encapsulate the resources that are shared by the entire
     * application.
     * 
     * <p>
     * The ResourceBundle (names) for the chain of ResourceMaps
     * are defined by three methods: {@link #getClassBundleNames},
     * {@link #getPackageBundleNames}, {@link
     * #getApplicationBundleNames}.  Collectively they define the
     * standard location for {@code ResourceBundles} for a particular
     * class as the {@code resources} subpackage.  For example, the
     * ResourceBundle for a class {@code com.myco.MyScreen}, would
     ...
     * is a comprehensive list of the ResourceMaps and their constituent 
     ...
     *     <tr>
     *       <td>2</td>
     *       <td>package: com.myco</td>
     *       <td>com.myco.resources.PackageResources</td>
     *       <td>com/myco/resources/PackageResources.properties</td>
     *     </tr>
     *     <tr>
     *       <td>3</td>
     ...
     * the one later in the list has precedence
     * <p>
     ...
     * beginning with the resource defined for the application's class, i.e.
     ...
     * by the {@link #getApplicationBundleNames} property.  
     * 
     * @see #setApplicationBundleNames
     */
     ...
     * <p>
     * This method is used by {@link #getResourceMap(Class)
     * getResourceMap()} to compute the list of ResourceBundle names
    ...
    /**
     * Map from a class to a list of the names of the 
     * {@code ResourceBundles} that are shared by 
     ...
     * <p>
     * By default this method returns one ResourceBundle 
     * name, {@code "resources.PackageResources"} defined
     * relative to the package of the {@code cls} argument.
     * <p>
     * For example, given a class named
     * {@code com.foo.bar.MyClass}, the package 
     * ResourceBundle name would
     * be {@code "com.foo.bar.resources.PackageResources"}.
     * <p>
     * This method is used by {@link #getResourceMap(Class)
     * getResourceMap()} to compute the list of ResourceBundle names
     * for a new {@code ResourceMap}.  ResourceManager subclasses
     * can override this method to add additional package-shared
     * ResourceBundle names to the list.
     * 
     * @param cls the named ResourceBundles are for all classes 
     *     in the same package as {@code cls}.
     * @return the names of the ResourceBundles to be loaded 
     *     for classes in {@code cls.getPackage()}.
     * @see #getResourceMap
     * @see #getClassBundleNames
     * @see #getApplicationBundleNames
     */
