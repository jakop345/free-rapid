...
public class GeneralTab extends UserPreferencesTab {
    ...
    public void init() {
        ...
        bind(checkNewLinkCheckDownloadHistory, UserProp.ENABLE_NEW_LINK_CHECK_DOWNLOAD_HISTORY, UserProp.ENABLE_NEW_LINK_CHECK_DOWNLOAD_HISTORY_DEFAULT);
        ...
        bind(comboFileExists, UserProp.FILE_ALREADY_EXISTS, UserProp.FILE_ALREADY_EXISTS_DEFAULT, "fileAlreadyExistsOptions", 4);
        bind(comboRemoveCompleted, UserProp.REMOVE_COMPLETED_DOWNLOADS, UserProp.REMOVE_COMPLETED_DOWNLOADS_DEFAULT, "removeCompletedOptions", 3);
    ...
    public void build(final CellConstraints cc) {
        ...
        checkNewLinkCheckDownloadHistory = new JCheckBox();
        checkNewLinkCheckDownloadHistory.setName("checkNewLinkCheckDownloadHistory");
        ...
        //======== panelDownloadsSettings ========
        {
            ...
            panelDownloadsSettingsBuilder.add(checkNewLinkCheckDownloadHistory, cc.xywh(3, 7, 7, 1));
            panelDownloadsSettingsBuilder.add(checkSkipDuplicateFiles, cc.xywh(3, 8, 7, 1));
            panelDownloadsSettingsBuilder.add(checkAutoShutDownDisabledWhenExecuted, cc.xywh(3, 9, 7, 1));
            panelDownloadsSettingsBuilder.add(checkPreventStandbyWhileDownloading, cc.xywh(3, 10, 7, 1));
            panelDownloadsSettingsBuilder.add(labelIfFilenameExists, cc.xywh(3, 12, 1, 1, CellConstraints.RIGHT, CellConstraints.DEFAULT));
            panelDownloadsSettingsBuilder.add(comboFileExists, cc.xy(5, 12));
            panelDownloadsSettingsBuilder.add(labelRemoveCompleted, cc.xywh(7, 12, 1, 1, CellConstraints.RIGHT, CellConstraints.DEFAULT));
            panelDownloadsSettingsBuilder.add(comboRemoveCompleted, cc.xy(9, 12));
        }
