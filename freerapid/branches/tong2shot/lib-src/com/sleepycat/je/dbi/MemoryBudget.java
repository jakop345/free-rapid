...
public class MemoryBudget implements EnvConfigObserver {
    ...
    // 12
    private final static int BIN_FIXED_OVERHEAD_32 = 208;
    private final static int BIN_FIXED_OVERHEAD_64 = 328;
    private final static int BIN_FIXED_OVERHEAD_OOPS = 224;
    ...
    // 13
    private final static int IN_FIXED_OVERHEAD_32 = 296;
    ...
    // 56
    private final static int DOS_OFFHEAP_BINREF_OVERHEAD_32 = 40;
    ...
    private final static int DOS_DEFERRED_LSN_BATCH_OVERHEAD_64 = 88;
    private final static int DOS_DEFERRED_LSN_BATCH_OVERHEAD_OOPS = 88;

    // 58
    private final static int DOS_DEFERRED_DELTAREF_OVERHEAD_32 = 88;
    private final static int DOS_DEFERRED_DELTAREF_OVERHEAD_64 = 128;
    private final static int DOS_DEFERRED_DELTAREF_OVERHEAD_OOPS= 88;
