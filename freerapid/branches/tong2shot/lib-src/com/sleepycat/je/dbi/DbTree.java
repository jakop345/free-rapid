...
public class DbTree implements Loggable {
    ...
    private static class RewriteMapLN implements WithRootLatched {
        ...
        public IN doWork(@SuppressWarnings("unused") ChildReference root)
            ...
            cursor.updateCurrentRecord(null,  // replaceKey
                                       dataDbt,
                                       null,  // foundData
                                       null,  // returnNewData
    ...
    public void updateNameLN(Locker locker, 
        ...
        try {
            ...
            /* Log a NameLN. */
            DatabaseEntry dataDbt = new DatabaseEntry(new byte[0]);
            nameCursor.updateCurrentRecord(null, // replaceKey
                                           dataDbt,
                                           null, // foundData
                                           null, // returnNewData
                                           useRepContext,
    ...
    public DatabaseImpl getDb(Locker nameLocker,
        ...
        try {
            ...
            boolean found = nameCursor.searchExact(keyDbt, LockType.READ);
     ...
     */
    public boolean verify(final VerifyConfig config,
        ...
        synchronized (envImpl.getINCompressor()) {
            ...
            class Traversal implements CursorImpl.WithCursor {
                ...
                public boolean withCursor(CursorImpl cursor,
                    ...
                    MapLN mapLN = (MapLN) cursor.lockAndGetCurrentLN(lockType);
