...
public abstract class BaseUtilizationTracker {
    ...
    /**
     * Bytes written to the log since the cleaner was last awoken.  This field
     * is incremented under the log write latch, which is safe.  However, it is
     * also set to zero by UtilizationTracker.activateCleaner, outside the log
     * write latch, and therefore it must be volatile here.  [#21106]
     */
    ...
    final boolean countNew(long lsn,
        ...
        return (bytesSinceActivate >= cleaner.cleanerBytesInterval);
    }
