...
public class FileSummary implements Loggable, Cloneable {
    ...
    public int getObsoleteLNSize() {
        return getObsoleteLNSize(Float.NaN);
    }
     ...
     *
     * @param obsoleteLNSizeCorrectionFactor is the correction factor to use
     * for uncounted LNs, or NaN to use the default average size calculation.
     */
    private int getObsoleteLNSize(float obsoleteLNSizeCorrectionFactor) {
