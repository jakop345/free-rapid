...
public class FeederReader extends VLSNReader {
    ...
    public OutputWireRecord scanForwards(VLSN vlsn, int waitTime)
        ...
        try {
             ...
             * with the feeder reader state, and therefore it could be
    ...
    /**
     * Specific internal exception used to indicate that a log file was not
     * found during a forward scan of the feeder reader. This is to be
     * expected in some circumstances, see
     * {@link FeederReplicaSyncup#makeResponseToEntryRequest} for details.
     */
    public static class LogFileNotFoundException extends RuntimeException {
        ...
        LogFileNotFoundException(VLSN vlsn,
                                 String msg,
                                 IOException ioe) {
            super(msg, ioe);
