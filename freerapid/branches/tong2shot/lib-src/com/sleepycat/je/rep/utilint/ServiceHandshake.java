...
public class ServiceHandshake {
     ...
     * for the server side.
     */
    abstract static class ServerInitOp {
         ...
         */
        abstract InitResult processOp(DataChannel channel)
            throws IOException;
     ...
     * mode.
     */
    abstract static class ClientInitOp {
         ...
         */
        abstract InitResult processOp(IOAdapter ioAdapter)
            throws IOException;
