...
public class StatsFileReader extends DumpFileReader {
    ...
    protected boolean processEntry(ByteBuffer entryBuffer) {
        ...
        if (lastEntryType.isUserLNType()) {
            ...
            LNLogEntry<?> entry =
                (LNLogEntry<?>) lastEntryType.getSharedLogEntry();
    ...
    private void summarizeText() {
        ...
        sb.append(pad(form.format(realTotalKeyBytes / realTotalKeyCount)));
        String realSize = "(" +
        ...
        sb.append(pad(form.format(realTotalDataBytes / realTotalDataCount)));
        realSize = "(" +
