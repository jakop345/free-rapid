 ...
 *
 * <!-- begin JE only -->
 * <p>Note that {@code READ_UNCOMMITTED} can be used with a key cursor to
 ...
 *
 * <!-- begin JE only -->
 * <p>This is a DPL version of the {@link <a
...
public interface EntityIndex<K, V> {
     ...
     *
     * <!-- begin JE only -->
     * <p>{@code READ_UNCOMMITTED} can be used with this method to reduce I/O,
     ...
     * {@link EntityIndex#count(long memoryLimit)} method.</p>
     *
     * <!-- end JE only -->
     *
     ...
     * will still work properly, but its performance will degrade.</p>
     *
     * @return the number of entities in this index.
     *
     * @throws OperationFailureException if one of the <a
     ...
     * {@link CursorConfig} and {@link com.sleepycat.je.TransactionConfig}.</p>
     * <!-- end JE only -->
     *
     * @param txn the transaction used to protect all operations performed with
     * the cursor, or null if the operations should not be transaction
