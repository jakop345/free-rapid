 ...
 * @author birchie
 */
class One23WzwpFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(One23WzwpFileRunner.class.getName());
    ...
    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        ...
        Matcher match = PlugUtils.matcher("class=\"header_content\">.*?：(.+?)&nbsp;", content);
        if (!match.find())
