 ...
 * @author Vity
 */
public class PluginToolManager implements IAreaChangeListener {
    ...
    private final static Logger logger = Logger.getLogger(PluginToolManager.class.getName());

    public PluginToolManager(ToolWindowManager toolWindowManager) {
    ...
    private void registerNewOne(PluginTool pluginTool, final boolean activate) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                toolWindow.setAvailable(activate);
                toolWindow.setActive(activate);
            }
        });
    }
